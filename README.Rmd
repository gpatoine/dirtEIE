...
dirtEIE aims to provide functions to ease and streamline lab data processing and analyses commonly performed in the
[EIE group](https://www.idiv.de/en/groups-and-people/core-groups/experimental-interaction-ecology.html).

The package aims to provide workflows for the following data types, some of which are currently being implemented :

* O2 micro-compensation measurements (basal respiration, microbial carbon, etc.). Documentation is currently available with the [o2eie package](https://github.com/gpatoine/o2eie).
